...
namespace PapugarniaOnline.DAL
{
    public class PapugarniaInitializer
    {
        public static void Initialize(PapugarniaOnlineContext context)
            ...
            kop.ForEach(k => context.KindOfParrots.Add(k));
            context.SaveChanges();
            ...
            parrot.ForEach(p => context.Parrots.Add(p));
            context.SaveChanges();

            var kot = new List<KindOfTicket>()
            {
                new KindOfTicket { Name = "Dla jednej osoby" },
                new KindOfTicket { Name = "Rodzinny" },
                new KindOfTicket { Name = "Grupowy" }
            };
            kot.ForEach(o => context.KindOfTickets.Add(o));
            context.SaveChanges();
            ...
            ticket.ForEach(t => context.Tickets.Add(t));
            context.SaveChanges();
